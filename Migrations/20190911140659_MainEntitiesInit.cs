...
{
    public partial class MainEntitiesInit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectsUsersRoles", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeStart = table.Column<byte>(nullable: false),
                    TimeEnd = table.Column<byte>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 16, 1 });

            migrationBuilder.InsertData(
                table: "RolesPermissions",
                columns: new[] { "Id", "Permission", "RoleId" },
                values: new object[] { 2, 17, 2 });

            migrationBuilder.InsertData(
                table: "RolesPermissions",
                columns: new[] { "Id", "Permission", "RoleId" },
                values: new object[] { 3, 22, 2 });
